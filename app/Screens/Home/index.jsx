...
const Home = () => {
  ...
  const [comment, setComment] = useState('Enter Message...');
  const data = [
    {
      username: 'Monty Lopez',
      userImg:
        'https://preview.keenthemes.com/metronic-v4/theme/assets/pages/media/profile/profile_user.jpg',
      category: 'Films & TV',
      time: '4 hours ago',
      des: 'Join us for a memorable evening celebrating design, culture and craftmanship with fellow industry leaders',
      image:
    ...
    {
      username: 'Jonathan Cooper',
      userImg:
        'https://preview.keenthemes.com/metronic-v4/theme/assets/pages/media/profile/profile_user.jpg',
      category: 'esport',
      time: '4 hours ago',
      des: 'Does anyone have a contact for a music lawyer who would be able to review a UMG contact this week',
      likes: 5,
      comments: '02',
    },
    {
  ...
  const actions = [
    {
      text: 'Feed',
      icon: <FontAwesomee name="feed" color="white" size={20} />,
      name: 'Feed',
      position: 2,
    },
    {
  ...
  return (
    <View
          ...
          <View style={{flexDirection: 'column', flex: 1}}>
            <View
              ...
              <View style={{position: 'absolute', left: 10}}>
                <TouchableOpacity onPress={() => setActive('Feed')}>
            ...
            <View
              ...
              <View
                ...
                <FontAwesome name="image" color="white" size={20} />
              </View>
              <View
                style={{
                  marginLeft: 10,
                ...
                <View style={{position: 'absolute', right: 10, top: 7}}>
                  <MaterialIcons name="add-comment" color="white" size={20} />
                </View>
              </View>
            </View>
          </View>
      ...
      <View style={{alignItems: 'flex-end'}}>
        ...
        <FloatingAction
          // style={{zIndex: 10000, position: 'absolute', right: 10}}
          textElevation={100}
          actions={actions}
          onPressItem={name => {
            setActive(name);
